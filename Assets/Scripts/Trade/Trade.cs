...
public class Trade : MonoBehaviour {
    ...
    void Start () {
        ...
        substancebutton.onClick.AddListener(delegate { press_smthbutton(); });
	...
	void Update () {
        ...
        if (sellgold.active == true && buysubstance.active == true)
        {
            y_buy = x_sell * 3;
            if (y_buy > 1000 - player.GetComponent<Player>().substance)
            {
                while (y_buy > 1000 - player.GetComponent<Player>().substance)
                {
                    x_sell--;
                    y_buy = x_sell * 3;
                }
        ...
        if (sellgold.active == true && buyfuel.active == true)
        {
            y_buy = x_sell * 0.5f;
            if (y_buy > 100 - player.GetComponent<Player>().fuel)
            {
                while (y_buy > 100 - player.GetComponent<Player>().fuel)
                {
                    x_sell--;
                    y_buy = x_sell * 0.5f;
                }
        ...
        if (sellcrystals.active == true && buysubstance.active == true)
        {
            y_buy = x_sell * 2;
            if (y_buy > 1000 - player.GetComponent<Player>().substance)
            {
        ...
        if (sellcrystals.active == true && buyfuel.active == true)
        {
            y_buy = x_sell / 3;
            if (y_buy > 100 - player.GetComponent<Player>().fuel)
            {
        ...
        if (sellsubstance.active == true && buygold.active == true)
        {
            y_buy = x_sell / 3;
            if (y_buy > 1000 - player.GetComponent<Player>().money)
            {
        ...
        if (sellsubstance.active == true && buycrystals.active == true)
        {
            y_buy = x_sell / 2;
            if (y_buy > 1000 - player.GetComponent<Player>().crystals)
            {
        ...
        if (sellsubstance.active == true && buysubstance.active == true)
        {
            y_buy = x_sell;
            if (y_buy > 1000 - player.GetComponent<Player>().substance)
            {
        ...
        if (sellsubstance.active == true && buyfuel.active == true)
        {
            y_buy = x_sell / 6;
            if (y_buy > 100 - player.GetComponent<Player>().fuel)
            {
        ...
        if (sellfuel.active == true && buysubstance.active == true)
        {
            y_buy = x_sell * 6;
            if (y_buy > 1000 - player.GetComponent<Player>().substance)
            {
        ...
        if (sellfuel.active == true && buyfuel.active == true)
        {
            y_buy = x_sell;
            if (y_buy > 100 - player.GetComponent<Player>().fuel)
            {
    ...
    public void press_1plus()
    {
        ...
        if (x_sell + 1 <= player.GetComponent<Player>().substance && sellsubstance.active == true)
        {
            x_sell += 1;
            Sellvalue.text = string.Format("{0:0}", x_sell);
        }
    ...
    public void press_10plus()
    {
        ...
        if (player.GetComponent<Player>().substance > x_sell && sellsubstance.active == true)
        {
            if (x_sell + 10 <= player.GetComponent<Player>().substance)
            {
                x_sell += 10;
                Sellvalue.text = string.Format("{0:0}", x_sell);
            }
            ...
            {
                while (x_sell != player.GetComponent<Player>().substance)
                {
                    x_sell++;
                }
                Sellvalue.text = string.Format("{0:0}", x_sell);
    ...
    public void press_100plus()
    {
        ...
        if (player.GetComponent<Player>().substance > x_sell && sellsubstance.active == true)
        {
            if (x_sell + 100 <= player.GetComponent<Player>().substance)
            {
                x_sell += 100;
                Sellvalue.text = string.Format("{0:0}", x_sell);
            }
    ...
    public void press_1000plus()
    {
        ...
        if (player.GetComponent<Player>().substance > x_sell && sellsubstance.active == true)
        {
            if (x_sell + 1000 <= player.GetComponent<Player>().substance)
            {
                x_sell += 1000;
                Sellvalue.text = string.Format("{0:0}", x_sell);
            }
    ...
    public void press_trade()
    {
        ...
        if (sellsubstance.active == true)
        {
            player.GetComponent<Player>().substance -= x_sell;
        }
        ...
        if (buysubstance.active == true)
        {
            player.GetComponent<Player>().substance += y_buy;
        }

        if (buyfuel.active == true)
        {
            player.GetComponent<Player>().fuel += y_buy;
        }
    }
